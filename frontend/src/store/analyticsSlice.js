...
const buildAnalytics = (definedSchoolYears = [], students = [], includeMissingYearEntries = true) => {
...
export const fetchAnalytics = createAsyncThunk('analytics/fetchAnalytics', async ({ schoolYear, semester } = {}, { rejectWithValue }) => {
  try {
    const params = {};
    ...
    const includeMissingYearEntries = !schoolYear && !semester;
    return buildAnalytics(definedSchoolYears, students, includeMissingYearEntries);
  } catch (error) {
