...
export default function AdminDashboard() {
  ...
  useEffect(() => { if (showManageUsers) fetchStudents(); }, [showManageUsers]);
  useEffect(() => {
      ...
      <div className="page-content">
        <div className="mb-8 rounded-3xl border border-white/15 bg-white/10 py-3 px-4 shadow-card backdrop-blur-xl md:py-4 md:px-5">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="grid grid-cols-2 gap-3 justify-end">
              <div className="w-full max-w-[150px] rounded-2xl border border-white/10 bg-primary-950/30 px-3 py-2">
                <p className="text-[10px] uppercase tracking-wide text-primary-200">School Year</p>
                <p className="mt-1 text-sm font-semibold text-white">{currentYear}</p>
              </div>
              <div className="w-full max-w-[150px] rounded-2xl border border-white/10 bg-primary-950/30 px-3 py-2">
                <p className="text-[10px] uppercase tracking-wide text-primary-200">Semester</p>
                <p className="mt-1 text-sm font-semibold text-white">{currentSemester}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="card mb-6 p-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
              <h2 className="text-base font-semibold text-slate-900">Student Competency</h2>
              <p className="text-sm text-slate-500">Open the assessment dashboard to review student competency status.</p>
            </div>
            <button
              type="button"
